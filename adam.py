...
def editarAluno() -> None:
    ...
    opcao = messagebox.askyesno('tem certeza?', 'Deseja alterar os dados dos alunos?')
    if opcao :
        alunos[index] = {
            'matricula': matricula,
            'nome': novo_nome,
        ...
        limparCampos()
        atualizarTabela()
        messagebox.showinfo('Atualizado!', 'Dados auterados com sucesso!')
...
label_busca = Label(janela, text='Buscar(nome):', font='Arial 14 bold', fg='red')
